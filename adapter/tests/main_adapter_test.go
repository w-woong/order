...
func setup() error {
	var err error
	if onlinetest {
		dsn := "host=testpghost user=test password=test123 dbname=woong_order port=5432 sslmode=disable TimeZone=Asia/Seoul"
		...
		gdb.AutoMigrate(&entity.Cart{}, &entity.CartProduct{})
	}
	return nil
}
